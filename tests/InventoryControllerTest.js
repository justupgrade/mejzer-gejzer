...
InventoryControllerTest.prototype.testAddItem = function() {
	...
	var options = {"type":"weapon", "damage":1, "id": 1};
...
InventoryControllerTest.prototype.testFindItem = function() {
	...
	var options = {"type":"weapon", "damage":1, "id": 2};
...
InventoryControllerTest.prototype.testMoveItem = function() {
	...
	options = {"type":"weapon", "damage":2, "id": 2};
	var item2 = factory.create(options); 
	...
	options = {"type":"armor", "protection":1, "id": 3};
	var armor1 = factory.create(options);
	options = {"type":"armor", "protection":2, "id": 4};
...
InventoryControllerTest.prototype.testWearItem = function() {
	controller.addItem(factory.create({"type":"armor", "protection":1, "id": 3}));
	controller.addItem(factory.create({"type":"armor", "protection":2, "id": 4}));
	controller.addItem(factory.create({"type":"weapon", "damage":2, "id": 2}));
	controller.addItem(factory.create({"type":"weapon", "damage":1, "id": 1}));
